...
const Cart = () => {
  ...
  if (!cart.length) {
    return (
      <div className="flex flex-col items-center justify-center mt-20 space-y-4  bg-gray-50">
  ...
  <div className="lg:col-span-2 space-y-6">
    {cart.map((product) => (
      <div
        key={product.id}
        className="flex flex-col sm:flex-row items-center sm:items-start justify-between bg-white shadow p-4 rounded-lg gap-4"
      >
        <div className="flex items-center gap-4 w-full sm:w-auto">
          ...
          <div className="text-center sm:text-left">
            ...
            <p className="text-yellow-600 font-bold mt-1 text-sm sm:text-base">
  ...
  <div className="bg-white shadow rounded-lg p-6 h-auto lg:h-[250px] flex flex-col justify-between">
    <div>
